...
def trainNet(output_dir, stego_dir, iteration, gpu_num, train_index_path, test_index_path, fiter):

	log_path = output_dir + '/' + 'model-log-final'
