...
pt_path = './adv-spa-bl-p.4/0-params.pt'
print("\tread checkpoint path:", pt_path)
temp_stego_dir = '/data/stt/adv_spa_bl_p0.4/stego1'
print("\ttest stego path:", temp_stego_dir)
index_path = './index_list/test/test_image.npy'
